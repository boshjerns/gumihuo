            ...
            <main className={styles.main}>
                <div className={styles.mintCard}>
                    ...
                    <div className={styles.mintCardBody}>
                        ...
                        {!loading && <button onClick={handleMint} className={styles.MintButton}  enabled={!provider}>Mint</button>}
                        {loading && <button className={styles.MintbuttonEnabled} enabled>...Minting...</button>}
